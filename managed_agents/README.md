...
The Managed Agents API features above — multi-agent sessions, outcomes, dreams, and webhooks — will be documented with full working code examples in the [claude_api_cookbook](https://github.com/ArchieCur/claude_api_cookbook) repo. This file is an orientation guide; the cookbook is where the deep implementation patterns live.
